...
const userQuantity = prompt('Какое количество желаете заказать?');
let message;
let totalPrice;
...
if (userQuantity === null) {
    ...
    totalPrice = userQuantity * pricePerDroid;
}
...
if (totalPrice > credits) {
    ...
    credits -=totalPrice;
    message = `Вы купили ${userQuantity} дроидов, на счету осталось ${credits} кредитов.`
}
console.log(message);
